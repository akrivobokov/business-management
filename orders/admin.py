...
class BannerAdmin(admin.ModelAdmin):
    list_display = ('title', 'cells', 'placement_x', 'placement_y', 'placement_width', 'placement_height', 'is_active', 'is_compliant', 'updated_at')
...
class PixelOrderAdmin(admin.ModelAdmin):
    list_display = ('id', 'buyer_type', 'cell_count', 'total_amount', 'status', 'telegram_status', 'created_at')
    list_filter = ('buyer_type', 'status', 'telegram_status', 'created_at')
